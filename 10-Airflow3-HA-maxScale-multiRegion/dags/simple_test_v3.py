"""
DAG simple compatible con Airflow 3.x para probar funcionamiento básico.
Usa los imports correctos para Airflow 3.x.
"""
...
with DAG(
    dag_id="simple_test_v3",
    description="DAG simple compatible con Airflow 3.x",
    schedule=None,
    start_date=datetime(2025, 1, 1),
    catchup=False,
    max_active_runs=1,
    tags=["test", "simple", "airflow3", "connectivity"],
    default_args={
        "retries": 1,
